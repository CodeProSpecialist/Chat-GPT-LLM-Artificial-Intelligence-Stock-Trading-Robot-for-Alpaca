...
def trading_robot(symbol, X, Y):
    ...
    content = (
        ...
        f"The exception and the default rules for buying at the early times is that we never buy "
        f"during the early hour time range of 4:00-10:14 unless the current price "
        f"and the opening price is less than yesterday's closing price. "
