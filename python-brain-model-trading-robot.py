...
def trading_robot(symbol, X, Y):
    ...
    content = (
        ...
        f"Friday, default mandatory rule is to sell everything 11:40-12:10 because prices decrease until Monday. "
        f"Friday, default mandatory rule is no buying after 11:40 because prices decrease until Monday. "
