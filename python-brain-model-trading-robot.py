...
def trading_robot(symbol, X, Y):
    ...
    messages = [
        {
            'role': 'user',
            'content': f"{symbol} price changed by {X}% in the past {Y} days. The RSI is {rsi:.2f} and the 50-day MA is {short_ma:.2f} and the 200-day MA is {long_ma:.2f}. The price has changed by {fourteen_days_change:.2f}% in the past 14 days. Yesterday's closing price was {yesterday_close:.2f}, today's opening price was {today_open:.2f}, and today's current price is {today_current:.2f}. The ATR is {atr:.2f} and the average volume is {avg_volume:.2f}. The Bollinger Bands are {upper_bb:.2f}, {middle_bb:.2f}, and {lower_bb:.2f}. The market trend is {market_trend}. We buy during a bull market trend and we stop buying during a bear market trend. Buy when the price is lesser than or equal to the lower Bollinger band and sell when the price is equal to or greater than the upper Bollinger band. Should I buy or sell {symbol}? Instructions: Buy if RSI < 30 and 50-day MA > 200-day MA and the price has increased in the past 14 days and ATR > 1 and average volume > 100000, Sell if RSI > 70 and 50-day MA < 200-day MA and the price has decreased in the past 14 days and ATR < 1 and average volume < 100000, Hold otherwise. Answer only with buy {symbol}, sell {symbol}, or hold {symbol}.",
        },
    ]
