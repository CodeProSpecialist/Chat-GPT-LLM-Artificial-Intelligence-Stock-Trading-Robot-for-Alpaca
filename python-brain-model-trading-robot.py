...
def trading_robot(symbol, X, Y):
    ...
    content = (
        ...
        f"We prefer to sell during the times of 9:31 through 9:38 if the prices are increasing. "
        f"We also prefer to sell during the times of 19:30 through 19:59. "
